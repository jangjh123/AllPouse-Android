    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AllPouseAndroidTheme {
                ...
                val invalidDataDialogState = remember { mutableStateOf(false) }
                val invalidDataDialogTextState = remember { mutableStateOf("") }
                                                    ...
                                                    if (UserApiClient.instance.isKakaoTalkLoginAvailable(
                                                        ...
                                                        UserApiClient.instance.loginWithKakaoTalk(
                                                            ...
                                                            if (token != null) {
                                                                ...
                                                                socialLoginErrorDialogState.value =
                                                                    true
                                                            }
                                                        }
                                                    } else {
                                                        UserApiClient.instance.loginWithKakaoAccount(
                                                            this@LoginActivity) { token: OAuthToken?, _ ->
                                                            if (token != null) {
                                                                UserApiClient.instance.me { user, _ ->
                                                                    if (user != null) {
                                                                        socialId =
                ...
                NoticeDialog(
                    state = invalidDataDialogState,
                    text = invalidDataDialogTextState.value
                )
